...
DB_PATH = Path(__file__).parent.parent.parent / "travel.db"
...
def hash_password(password: str, email: str) -> str:
    data = (password + email.lower()).encode("utf-8")
...
def init_db():
    ...
    # Seed if empty
    row = conn.execute("SELECT COUNT(*) as cnt FROM travel").fetchone()
    if row["cnt"] == 0:
        seed_db(conn)
...
def seed_db(conn: sqlite3.Connection):
    # Demo users
    demo_hash = hash_password("demo1234", "demo@travel.app")
    conn.execute(
        "INSERT INTO users (email, password_hash, name) VALUES (?, ?, ?)",
        ("demo@travel.app", demo_hash, "Demo User"),
    )

    manas_hash = hash_password("manas123", "mkmallik@gmail.com")
    conn.execute(
        "INSERT INTO users (email, password_hash, name) VALUES (?, ?, ?)",
        ("mkmallik@gmail.com", manas_hash, "Manas"),
    )
    ...
    italy_itineraries = [
        ...
        (1, "2026-03-16", 2, "Rome", "https://picsum.photos/seed/rome-vatican/800/400", None, "Walk", 0, "Hotel Roma Centro", "Via del Corso 42, Rome", "BK-001", 120, 42, 8, 18, 10, "Vatican Museums, St. Peters Basilica, Sistine Chapel", "Book Vatican tickets in advance!"),
        (1, "2026-03-17", 3, "Florence", "https://picsum.photos/seed/florence-duomo/800/400", None, "Train", 45, "B&B Firenze Belle", "Piazza Santa Croce 8, Florence", "BK-002", 95, 38, 6, 20, 8, "Uffizi Gallery, Ponte Vecchio, Duomo", "Trenitalia Frecciarossa from Roma Termini"),
        (1, "2026-03-18", 4, "Florence", "https://picsum.photos/seed/florence-ponte/800/400", None, "Walk", 0, "B&B Firenze Belle", "Piazza Santa Croce 8, Florence", "BK-002", 95, 40, 5, 15, 12, "Accademia Gallery (David), San Lorenzo Market", "Bought leather goods at the market"),
        (1, "2026-03-19", 5, "Venice", "https://picsum.photos/seed/venice-grand/800/400", None, "Train", 38, "Casa Venezia", "Cannaregio 2356, Venice", "BK-003", 140, 55, 20, 30, 15, "Grand Canal, Rialto Bridge, St. Marks Square", "Water taxi from station to hotel was pricey"),
        (1, "2026-03-20", 6, "Venice", "https://picsum.photos/seed/venice-burano/800/400", None, "Walk", 0, "Casa Venezia", "Cannaregio 2356, Venice", "BK-003", 140, 48, 15, 22, 8, "Murano Island, Burano Island", "Day pass for vaporetto - good value"),
        (1, "2026-03-21", 7, "Milan", "https://picsum.photos/seed/milan-duomo/800/400", None, "Train", 32, "Milano Centrale B&B", "Via Napo Torriani 15, Milan", "BK-004", 110, 45, 10, 16, 20, "Duomo di Milano, Galleria Vittorio Emanuele", "Shopping in Galleria"),
        (1, "2026-03-22", 8, "Milan", "https://picsum.photos/seed/milan-galleria/800/400", "AZ567 MXP→CDG 16:00", "Flight", 95, None, None, None, 0, 22, 15, 0, 0, "Last Supper (booked months ago!)", "Early flight home"),
    ]

    for it in italy_itineraries:
        conn.execute(
    ...
    for e in italy_expenses:
        conn.execute(
            "INSERT INTO expense (travel_id, date, description, category, amount_eur, amount_local, local_currency_code) VALUES (1, ?, ?, ?, ?, ?, ?)",
            e,
        )
    ...
    japan_itineraries = [
        ...
        (2, "2026-04-29", 2, "Tokyo", "https://picsum.photos/seed/tokyo-sensoji/800/400", None, "Train", 0, "Shinjuku Granbell Hotel", "Kabukicho, Shinjuku, Tokyo", "GR-101", 95, 45, 8, 12, 10, "Senso-ji, Akihabara, Shibuya Crossing", "Bought JR pass - great value"),
        (2, "2026-04-30", 3, "Tokyo", "https://picsum.photos/seed/tokyo-teamlab/800/400", None, "Train", 0, "Shinjuku Granbell Hotel", "Kabukicho, Shinjuku, Tokyo", "GR-101", 95, 50, 5, 18, 15, "Tsukiji Outer Market, TeamLab, Harajuku", "TeamLab was incredible"),
        (2, "2026-05-01", 4, "Kyoto", "https://picsum.photos/seed/kyoto-fushimi/800/400", None, "Train", 0, "Kyoto Machiya Inn", "Higashiyama, Kyoto", "MI-201", 110, 35, 5, 15, 8, "Fushimi Inari, Kinkaku-ji, Arashiyama", "Shinkansen from Tokyo - 2h15m"),
        (2, "2026-05-02", 5, "Kyoto", "https://picsum.photos/seed/kyoto-gion/800/400", None, "Bus", 5, "Kyoto Machiya Inn", "Higashiyama, Kyoto", "MI-201", 110, 40, 8, 10, 5, "Nijo Castle, Gion district, Tea ceremony", "Tea ceremony was a highlight"),
        (2, "2026-05-03", 6, "Osaka", "https://picsum.photos/seed/osaka-dotonbori/800/400", None, "Train", 0, "Hotel Osaka Bay", "Namba, Osaka", "OB-301", 85, 60, 10, 12, 8, "Dotonbori, Osaka Castle, Street food tour", "Osaka is a food paradise"),
        (2, "2026-05-04", 7, "Hiroshima", "https://picsum.photos/seed/hiroshima-peace/800/400", None, "Train", 0, "Hotel Osaka Bay", None, None, 0, 35, 5, 8, 5, "Peace Memorial, Miyajima Island", "Day trip from Osaka, very moving"),
        (2, "2026-05-05", 8, "Tokyo", "https://picsum.photos/seed/tokyo-meiji/800/400", None, "Train", 0, "Shinjuku Granbell Hotel", "Kabukicho, Shinjuku, Tokyo", "GR-101", 95, 40, 12, 0, 20, "Nakamise shopping, Meiji Shrine, Roppongi", "Last day shopping"),
        (2, "2026-05-06", 9, "Tokyo", "https://picsum.photos/seed/tokyo-narita/800/400", "AF276 NRT→CDG 10:30", "Flight", 580, None, None, None, 0, 15, 20, 0, 0, None, "Early morning departure"),
    ]

    for it in japan_itineraries:
        conn.execute(
            """INSERT INTO itinerary (travel_id, date, day_no, city, city_image_uri, flight_detail, transport_mode, transport_cost, hotel_name, hotel_address, booking_id, hotel_cost, food_cost, transportation_cost, activities_cost, misc_cost, activity_description, notes)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)""",
            it,
    ...
    for e in japan_expenses:
        conn.execute(
            "INSERT INTO expense (travel_id, date, description, category, amount_eur, amount_local, local_currency_code) VALUES (2, ?, ?, ?, ?, ?, ?)",
            e,
        )
